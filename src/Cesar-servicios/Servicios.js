      ...
      <div className="servicios-info">
        <ServCard
          ...
          onOpenModal={() =>
            openModal(
              [img15, img17, img16],
              "Servicios Integrales de Monitoreo y Ensayos Ambientales",
              "Realización de pruebas y análisis en laboratorio para evaluar la capacidad ambiental."
            )
          }
        />
        <ServCard
          ...
          onOpenModal={() =>
            openModal(
              [img12, img14],
              "Diseño de Reactores para Tratamiento de Aguas Residuales",
              "Desarrollo de reactores a nivel laboratorio y piloto para el tratamiento de aguas."
            )
          }
        />
        ...
        <ServCard
          ...
          onOpenModal={() =>
            openModal(
              [img13, img10],
              "Asesoramiento de Trabajos de Investigación y Postgrado",
              "Apoyo especializado para la elaboración de tesinas y tesis de pregrado y postgrado."
            )
          }
        />
      </div>
